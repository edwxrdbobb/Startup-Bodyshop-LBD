...
// For desktop
export const desktopHeaderPhrase = ["Introducing LBD Group's Next-", 'Gen Cards'];
export const desktopParagraphPhrase = [
  " DiscoverLBD Group's latest innovation – our new cards. Elevate your banking",
  'experience with cutting-edge features, security, and unprecedented',
  'convenience.',
];

// For mobile
export const mobileHeaderPhrase = ["IntroducingLBD Group's", 'Next-Gen Cards'];
export const mobileParagraphPhrase = [
  " DiscoverLBD Group's latest innovation – our new cards.",
